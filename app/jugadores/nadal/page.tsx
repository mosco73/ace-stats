export default function NadalPage() {
  return (
    <main className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="px-6 py-10 max-w-4xl mx-auto">
        <div className="flex items-center gap-5 mb-8">
          <div className="w-20 h-20 rounded-full bg-zinc-700 flex items-center justify-center text-2xl font-bold text-orange-400">
            RN
          </div>
          <div>
            <h1 className="text-3xl font-bold">Rafael Nadal</h1>
            <p className="text-zinc-400 mt-1">España · Zurdo · Pro desde 2001</p>
            <div className="flex gap-3 mt-2">
              <span className="text-xs bg-zinc-800 text-zinc-300 px-3 py-1 rounded-full">22 Grand Slams</span>
              <span className="text-xs bg-zinc-800 text-zinc-300 px-3 py-1 rounded-full">209 semanas #1</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
            ...
            <div className="text-2xl font-bold">61.8%</div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
            ...
            <div className="text-xs text-green-400 mt-1">+7.1% vs promedio ATP</div>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
            ...
            <div className="text-2xl font-bold">64.9%</div>
            <div className="text-xs text-zinc-500 mt-1">92 títulos / 142 finales</div>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
            <div className="text-xs text-zinc-500 mb-1">5to set en Grand Slams</div>
            <div className="text-2xl font-bold">59.1%</div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-center">
            ...
            <div className="text-xl font-bold text-blue-400">58.7%</div>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-center">
            <div className="text-xs text-zinc-500 mb-1">Arcilla</div>
            <div className="text-xl font-bold text-orange-400">71.4%</div>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-center">
            <div className="text-xs text-zinc-500 mb-1">Césped</div>
            <div className="text-xl font-bold text-green-400">56.2%</div>
          </div>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 flex flex-col gap-5">
          <div>
            <div className="flex justify-between text-sm mb-2">
              ...
              <span className="font-semibold">79.8%</span>
            </div>
            <div className="w-full bg-zinc-800 rounded-full h-2">
              <div className="bg-blue-400 h-2 rounded-full" style={{width: "79.8%"}}></div>
            </div>
            <div className="text-xs text-zinc-500 mt-1">521V · 132D</div>
          </div>
          <div>
            <div className="flex justify-between text-sm mb-2">
              <div className="flex items-center gap-2">
            ...
            <div className="w-full bg-zinc-800 rounded-full h-2">
              <div className="bg-orange-400 h-2 rounded-full" style={{width: "92.1%"}}></div>
            </div>
            <div className="text-xs text-zinc-500 mt-1">474V · 41D</div>
          </div>
          <div>
            <div className="flex justify-between text-sm mb-2">
              <div className="flex items-center gap-2">
            ...
            <div className="text-xs text-zinc-500 mt-1">98V · 32D</div>
          </div>
          <div>
            <div className="flex justify-between text-sm mb-2">
              <div className="flex items-center gap-2">
            ...
            <div className="w-full bg-zinc-800 rounded-full h-2">
              <div className="bg-purple-400 h-2 rounded-full" style={{width: "72.3%"}}></div>
            </div>
            <div className="text-xs text-zinc-500 mt-1">241V · 92D</div>
          </div>
        </div>
