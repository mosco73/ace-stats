      ...
      <section className="px-6 py-10 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-center">
            ...
            <div className="text-xl font-bold text-blue-400">64.8%</div>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-center">
            <div className="text-xs text-zinc-500 mb-1">Arcilla</div>
            <div className="text-xl font-bold text-orange-400">52.3%</div>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-center">
            <div className="text-xs text-zinc-500 mb-1">Césped</div>
            <div className="text-xl font-bold text-green-400">69.1%</div>
          </div>
        </div>
